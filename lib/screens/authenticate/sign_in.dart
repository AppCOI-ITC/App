...
class _SignInState extends State<SignIn> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(  
      ...
      appBar: AppBar(
        title: Text("Inicio de sesión",style: TextStyle(color: Color.fromARGB(255, 0x14, 0x53, 0x9A),fontWeight: FontWeight.bold)),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: Color.fromARGB(255, 0xFF, 0xED, 0xE1),
        actions: [
              ...
              child: Column(
                ...
                children: <Widget>[
                  TextFormField(
                    ...
                    decoration: textInputDecoration.copyWith(hintText: 'USUARIO'),
                  ...
                  TextFormField(
                    textAlign: TextAlign.center,
                    decoration: textInputDecoration.copyWith(hintText: 'CONTRASEÑA'),//<==== RESOLVER LABELTEXT
                    showCursor: false,
                    style: TextStyle(color: Color.fromARGB(255, 0x14, 0x53, 0x9A)),
                    obscureText: true,
                    validator: (val) => val.isEmpty ? 'Ingrese una clave' : null,
                    onChanged: (val) {
